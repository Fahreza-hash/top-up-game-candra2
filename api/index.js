...
const API_KEY = process.env.OpDGhvrMiR5PeqKJMMaPgMJljvHk95IwPYee78qJonu9EoZ89OQ7ONMahvd5kwW5sGcWf6KmfdUGTOpVkQknNSrFa41Uy4GZ4pFl;
...
app.get('/api/services', async (req, res) => {
    try {
        ...
        const response = await axios.post(`${ATLANTIC_BASE_URL}/layanan/price_list`, 
            qs.stringify({ api_key: OpDGhvrMiR5PeqKJMMaPgMJljvHk95IwPYee78qJonu9EoZ89OQ7ONMahvd5kwW5sGcWf6KmfdUGTOpVkQknNSrFa41Uy4GZ4pFl, type: 'prabayar' }), config);
...
app.post('/api/create-payment', async (req, res) => {
    ...
    try {
        const depoRes = await axios.post(`${ATLANTIC_BASE_URL}/deposit/create`, 
            qs.stringify({
                api_key: OpDGhvrMiR5PeqKJMMaPgMJljvHk95IwPYee78qJonu9EoZ89OQ7ONMahvd5kwW5sGcWf6KmfdUGTOpVkQknNSrFa41Uy4GZ4pFl, reff_id: reff_id, nominal: nominalBayar,
...
app.post('/api/check-status', async (req, res) => {
    ...
    try {
        const statusRes = await axios.post(`${ATLANTIC_BASE_URL}/deposit/status`,
            qs.stringify({ api_key: OpDGhvrMiR5PeqKJMMaPgMJljvHk95IwPYee78qJonu9EoZ89OQ7ONMahvd5kwW5sGcWf6KmfdUGTOpVkQknNSrFa41Uy4GZ4pFl, id: deposit_id }), config);
        ...
        if (status === 'success') {
            ...
            const buyRes = await axios.post(`${ATLANTIC_BASE_URL}/transaksi/create`,
                qs.stringify({
                    api_key: OpDGhvrMiR5PeqKJMMaPgMJljvHk95IwPYee78qJonu9EoZ89OQ7ONMahvd5kwW5sGcWf6KmfdUGTOpVkQknNSrFa41Uy4GZ4pFl, code: meta.code, target: meta.target, reff_id: trxReff
                }), config);
